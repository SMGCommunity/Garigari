...
void CollisionCode::createFloorTable() {
    ...
    mFloorTable->add("Oil", 0x23);
    mFloorTable->add("NoDig", 0x24);
    mFloorTable->add("Lawn", 0x25);
    mFloorTable->add("Cloud", 0x26);
    mFloorTable->add("PressAndNoSlip", 0x27);
    mFloorTable->add("ForceDash", 0x28);
    mFloorTable->add("DarkMatter", 0x29);
    mFloorTable->add("Dust", 0x2A);
    mFloorTable->add("SnowAndNoSlip", 0x2B);
}
...
void CollisionCode::createSoundTable() {
    ...
    mSoundTable->add("MetalHeavy", 0x10);
    mSoundTable->add("Marble_Snow", 0x11);
    mSoundTable->add("Marble_Soil", 0x12);
    mSoundTable->add("Metal_Soil", 0x13);
    mSoundTable->add("Cloud", 0x14);
    mSoundTable->add("Marble_Beach", 0x15);
    mSoundTable->add("Marble_Sand", 0x16);
}
...
const char* CollisionCode::getFloorCodeString(const Triangle &rTriangle) {
    u32 code = getCode(rTriangle.getAttributes(), mFloorTable, "Floor_code");
...
const char* CollisionCode::getWallCodeString(const Triangle &rTriangle) {
    u32 code = getCode(rTriangle.getAttributes(), mWallTable, "Wall_code");
...
const char* CollisionCode::getSoundCodeString(const Triangle &rTriangle) {
    return getSoundCodeString(rTriangle.getAttributes());
}
...
u32 CollisionCode::getCameraID(const Triangle &rTriangle) {
    return getCameraID(rTriangle.getAttributes());
}
